    ...
    <BaseModal title="System Artifact" onClose={onClose}>
      ...
      <div className="mb-8">
        <a
          ...
          style={{
            ...
            textDecorationColor: 'rgba(95,33,77,0.25)',
          }}
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLAnchorElement).style.textDecorationColor = 'rgba(95,33,77,0.45)';
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLAnchorElement).style.textDecorationColor = 'rgba(95,33,77,0.25)';
          }}
        >
      ...
      <div className="flex justify-end">
        <button
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLButtonElement).style.background = 'rgba(95,33,77,0.10)';
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLButtonElement).style.background = 'rgba(95,33,77,0.06)';
          }}
        >
          Close
        </button>
